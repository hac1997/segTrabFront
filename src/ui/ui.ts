import { criarListaContainer } from "../components/listaContainer";
import { criarSubtarefaDiv, gerarEventListenersSubtarefa } from "../components/subtarefa";
import { criarTarefaDiv } from "../components/tarefa";
import { atualizarCheckboxSubtarefas, atualizarStatusTarefa } from "../task/task";
import { Lista, Tarefa } from "../types/types";
import { media, puxarCheckedFiltroPrioridade, puxarCheckedFiltroStatus, puxarListas, puxarSubtarefas, puxarTarefas } from "../utils/utils";
import { dataExpirada, getAnoSemana, parseDataBrasil } from "../utils/utilsDataHora";
import { filtrarTarefas, filtroOrdenarDescricao, filtroOrdenarPrioridade, filtroOrdernarTempo, ordenarTarefas } from "../utils/utilsFiltros";
import { togglePopEditarTareda, togglePopTarefasAVencer } from "./uiPop";
...
export function criarElementoTarefa(tarefa: Tarefa) {
    ...
    if (dataExpirada(tarefa.data, tarefa.hora)) tarefaDiv.className = 'tarefa expirada';
